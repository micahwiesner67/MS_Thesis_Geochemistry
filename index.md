...
```
in which H<sub>2</sub>O-CaCO<sub>3</sub>, CO<sub>3</sub><sup>2-</sup>] , and [H <sup>+</sup>] are the activity of dissolved CO<sub>2</sub>, [CO<sub>3</sub><sup>2-</sup>], and [H <sup>+</sup>], while K<sub>1</sub> and K<sub>2</sub> are the dissociation constants of H<sub>2</sub>O-CaCO<sub>3</sub> (Stumm and Morgan, 1970). In a first order sense, Henry's Law (equation 3),
```math
3.\frac{[H_2CO_3^*]}{p_{CO_2}} = K_H
```
determines the amount of H<sub>2<sub>CO</sub>3<sub><sup>*</sup> in solution in the water column, though H<sub>2<sub>CO</sub>3<sub><sup>*</sup> in most lake waters is supersaturated (Cole et al., 1994). 
